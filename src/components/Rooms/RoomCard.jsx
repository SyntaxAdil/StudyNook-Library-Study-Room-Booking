...
const RoomCard = ({ room }) => {
  ...
  return (
    <motion.Card
      ...
      key={room._id}
      className=" bg-surface border border-border/60 rounded-2xl overflow-hidden hover:shadow-xl hover:border-accent/40 transition-all duration-300 flex flex-col justify-between p-4 space-y-2"
    >
