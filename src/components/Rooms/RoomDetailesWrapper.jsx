            ...
            >
              <div className="border-b border-border/60 pb-6">
                ...
                <div className="flex items-center gap-2 text-sm text-muted font-medium">
                  ...
                  <span>Listed on {room?.createdAt ? new Date(room.createdAt).toDateString() : "Recent"}</span>
                </div>
              </div>
              ...
              {room?.amenities && room?.amenities.length > 0 && (
                <div className="space-y-4 pt-4">
                  <h3 className="text-xl font-bold tracking-tight">Amenities</h3>
              ...
              <Card className="bg-surface border border-border/60 rounded-[2rem] p-6 shadow-xl shadow-surface-shadow">
                <div className="p-0 space-y-6">
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-muted text-sm font-semibold">per hour</span>
                  </div>
              ...
              <Card className="bg-surface/50 backdrop-blur-md border border-border/60 rounded-[2rem] p-6 shadow-lg">
                <div className="p-0 space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    <Avatar 
                      className="w-14 h-14 border-2 border-accent/20 rounded-2xl"
