...
import { FaBookReader, FaFacebookF, FaLinkedinIn, FaInstagram, FaEnvelope, FaPhoneAlt } from "react-icons/fa";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted text-sm leading-relaxed">
              StudyNook provides a seamless way for students to book private library study rooms, 
              ensuring focus and productivity without the hassle of double-bookings.
            </p>
          </div>
